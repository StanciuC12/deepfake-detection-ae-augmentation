...
class Double_UNet(nn.Module):
    ...
    def __init__(self, output=2):
        ...
        self.ASPP = ASPP()
        # Decoder1
        self.dec1_block1 = Decoder_Block(1024, 512, output_padding=1)
        self.dec1_block2 = Decoder_Block(512, 256)
        self.dec1_block3 = Decoder_Block(256, 128, output_padding=1)
        self.dec1_block4 = Decoder_Block(128, 64, output_padding=1)
        self.dec1_conv = nn.Conv2d(64, 3, 1)
        # encoder 2
        ...
        # decoder2
        self.dec2_block1 = Decoder2_Block(1024, 512, output_padding=1)
        self.dec2_block2 = Decoder2_Block(512, 256)
        self.dec2_block3 = Decoder2_Block(256, 128, output_padding=1)
        self.dec2_block4 = Decoder2_Block(128, 64, output_padding=1)
        self.dec2_conv = nn.Conv2d(64, 3, 1)
    ...
    def forward(self, x):
        ...
        if self.output == 1:
            ...
            return torch.cat([d1_output, d2_output])